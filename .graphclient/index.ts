...
const merger = new(BareMerger as any)({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: BadgerVaultsDocument,
        get rawSDL() {
          return printWithCache(BadgerVaultsDocument);
        },
        location: 'BadgerVaultsDocument.graphql'
      },{
        document: BadgerTokensDocument,
        get rawSDL() {
          return printWithCache(BadgerTokensDocument);
        },
        location: 'BadgerTokensDocument.graphql'
      }
    ];
    },
    fetchFn,
...
export type BadgerVaultsQueryVariables = Exact<{ [key: string]: never; }>;


export type BadgerVaultsQuery = { subgraphs: Array<(
    Pick<Subgraph, 'id' | 'displayName'>
    & { versions: Array<(
      Pick<SubgraphVersion, 'id' | 'createdAt' | 'label'>
      & { subgraphDeployment: Pick<SubgraphDeployment, 'id'> }
    )> }
  )> };

export type BadgerTokensQueryVariables = Exact<{ [key: string]: never; }>;


export type BadgerTokensQuery = { subgraphs: Array<(
    Pick<Subgraph, 'id' | 'displayName'>
    & { versions: Array<(
      Pick<SubgraphVersion, 'id' | 'createdAt' | 'label'>
      & { subgraphDeployment: Pick<SubgraphDeployment, 'id'> }
...
export const BadgerVaultsDocument = gql`
    query BadgerVaults {
  subgraphs(where: {displayName: "badger-vaults"}) {
    id
    displayName
    versions {
      id
    ...
    ` as unknown as DocumentNode<BadgerVaultsQuery, BadgerVaultsQueryVariables>;
export const BadgerTokensDocument = gql`
    query BadgerTokens {
  subgraphs(where: {displayName: "badger-tokens"}) {
    id
    displayName
    versions {
      id
    ...
    ` as unknown as DocumentNode<BadgerTokensQuery, BadgerTokensQueryVariables>;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    BadgerVaults(variables?: BadgerVaultsQueryVariables, options?: C): Promise<BadgerVaultsQuery> {
      return requester<BadgerVaultsQuery, BadgerVaultsQueryVariables>(BadgerVaultsDocument, variables, options) as Promise<BadgerVaultsQuery>;
    },
    BadgerTokens(variables?: BadgerTokensQueryVariables, options?: C): Promise<BadgerTokensQuery> {
      return requester<BadgerTokensQuery, BadgerTokensQueryVariables>(BadgerTokensDocument, variables, options) as Promise<BadgerTokensQuery>;
    }
  };
}
